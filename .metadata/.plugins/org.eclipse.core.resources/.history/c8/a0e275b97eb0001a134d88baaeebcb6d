...
//	public String testLogin(HttpSession session,@RequestParam Integer test) {
...
//		UserDto user;
//		if(test == 1) {
//			user = new UserDto("TEST","TEST","TEST","TEST","01012341234","주소","",0);			
//		}else {
//			user = new UserDto("ORG01","1111","(사)무지개세상","장승진","01012341234","서울특별시 서초구 매헌로 54 (양재동)","",1);
//		}
//		
