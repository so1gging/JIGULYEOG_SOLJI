				...
				<div class="col-md-6 pr-md-5" style="margin: 0 auto;">
					<form action="org_updateRes.do" method="POST"
						...
						<div class="form-group joinbox clearFix">
							<label
								style="float: left; line-height: 49px; padding-left: 10px;">환경단체를
								검색해주세요</label> <input type="button" value="Search" class="btn py-3 px-5"
								style="width: 180px; float: right;" id="search_org"
								onclick="popup();">
						</div>
						<div class="form-group joinbox">
							<input type="text" class="form-control px-3 py-3 join_input"
								readonly placeholder="Name" style="width: 500px;"
								name="user_name" id="user_name" value="${user.getUser_name() }">
						</div>
						<div class="form-group joinbox">
							<input type="text" class="form-control px-3 py-3 join_input"
								readonly placeholder="NickName" style="width: 500px;"
								name="user_nick" id="user_nick" value="${user.getUser_nick() }">
						</div>
						<div class="form-group joinbox">
							<input type="text" class="form-control px-3 py-3 join_input"
								readonly placeholder="Address" style="width: 500px;"
								name="user_addr" id="user_addr" value="${user.getUser_addr() }">
						</div>
						<div class="form-group joinbox">
